...
sudo apt install -y kubuntu-restricted-extras curl zsh build-essential vim git xserver-xorg-input-synaptics keepassx jq python3-pip golang wireshark nmap pwgen fortune cowsay lolcat sl steam vlc
